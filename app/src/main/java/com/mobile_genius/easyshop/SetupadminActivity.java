...
public class SetupadminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nombre = (EditText) findViewById(R.id.atxt_setup_nombre);
        direccion = (EditText) findViewById(R.id.atxt_setup_direccion);
        telefono = (EditText) findViewById(R.id.atxt_setup_telefono);
        ciudad = (EditText) findViewById(R.id.atxt_setup_ciudad);
        guardar = (Button) findViewById(R.id.abtn_setup);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    if (snapshot.hasChild("imagen")){
                        ...
                        Toast.makeText(SetupadminActivity.this, "Por favor seleccione una imagen de perfil....", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            @Override
